...
This is part of the `computer` from an automatic transmission [(read more)](
https://carpart.com.au/blog/what-is-a-valve-body). Fluid within the channels is under pressure during operation. There are various valves / solenoids that configure the system when it is operating - the shape and length of the channels is part of the programming because this changes the pressure drop and the time-delay for information to propagate within the system. This *is* a computer in the sense that it processes input states into output states. It is not programmable in the sense of having a programming language and it is certainly not a general purpose programmable machine. Perhaps you would like to think about how to debug a program on this architecture.

::: {#fig-transmission-hydraulic-computer}
![Transmission Valve Body](https://www.slashgear.com/img/gallery/what-is-a-transmission-valve-body-and-what-happens-when-it-has-gone-bad/how-the-transmission-valve-body-works-1738028207.webp){fig-align="center" width=80%}

Inside a tranmission valve body from [Slashgear.com](https://www.slashgear.com/1772860/transmission-valve-body-what-happens-when-its-bad-explanation/)
:::

There are many kinds of electronic computers that we will not be discussing such as the embedded systems in controllers, engines, cars, aircraft and so on. Some of these might use recognisable programming but many are heavily focused on the job that they must do quickly, with low overhead and no danger of crashing as they process critical information in real time. These systems may well have more in common with early electronic computers because complexity can be the enemy of reliability or at least of demonstrating reliability in the face of every conceivable input. If you build projects using microcontrollers, then you will quickly get a sense of this style of programming; what it offers and its limitations.
...
## How do we take advantage of re-usable computing ?
...
## What is the role of a human programmer in a world of AI ?
...
So there you have it: humans bring imagination, authority and a healthy dose of skepticism to the table. We can't help you with the first two, but we can work on the critical thinking skills that you will need.
